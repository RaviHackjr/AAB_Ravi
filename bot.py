...
app = Client(
    ...
    bot_token="7797381046:AAEguOkeLq6jxZtp7YUiVMo8-t3xzhJyXvQ",
)


@app.on_message(filters.command("start") & filters.private & filters.user(5983649308))
async def start(client, message: Message):
    await message.reply_text("Working...")


@app.on_message(filters.command("get") & filters.private & filters.user(5983649308))
...
@app.on_message(filters.command("post") & filters.private & filters.user(5983649308))
...
async def main():
    print("Starting...")
    await app.start()
    await app.send_message(5983649308, "Bot started!")
    print("Bot started!")
    await idle()
    await app.stop()
    print("Bot stopped!")
